...
<template>
  <nav :class="stickyNavbar? 'border-gray-200 shadow-md fixed bg-white z-50' : 'absolute'" class="w-screen pl-0 pr-7 py-2.5 rounded sm:px-4 dark:bg-gray-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div :class="!isMobile ? 'hidden' : ''"  class="justify-between items-center w-full bg-white rounded p-5 md:bg-transparent md:flex md:w-auto md:order-1" id="mobile-menu-4">
