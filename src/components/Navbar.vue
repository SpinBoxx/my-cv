...
<template>
  <nav :class="[stickyNavbar? 'border-gray-200 shadow-md fixed bg-white z-50' : 'absolute z-20',{'z-10 bg-white': isMobile} ]" class="w-screen pl-0 pr-7 py-2.5 rounded sm:px-4 dark:bg-gray-800">
